...
<%
    ...
    // Guardar URL original antes del login
    String urlOriginal = null;
    HttpSession sesionActual = request.getSession(false);
    if (sesionActual != null) {
        urlOriginal = (String) sesionActual.getAttribute("javax.servlet.forward.request_uri");
    }

    try {
        request.login(usuario, password);

        // Login exitoso — limpiar intentos y regenerar ID de sesión (session fixation)
